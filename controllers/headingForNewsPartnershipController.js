...
exports.updateHeadingForNewsPartnership = async (req, res) => {
    try {
        ...
        const noIncomingData =
            newsHeading === undefined && partnershipHeading === undefined && partnershipSubHeading === undefined;
        ...
        const noChanges =
            ...
            (partnershipHeading === undefined || partnershipHeading === existingDocument.partnershipHeading) &&
            (partnershipSubHeading === undefined || partnershipSubHeading === existingDocument.partnershipSubHeading);
